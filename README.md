...
Context API is used to simplify props, and prevent prop-drilling
...
Store contains the state object
3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?
Redux-thunk allows the reducer to flow in an asynchronous way.
4. What is your favorite state management system you've learned and this sprint? Please explain why!
overall, redux! It makes managing state through several components much easier.
